...
namespace WL_CSharp_Tester
{
	class Program 
	{
		...
		{
			//EminiTest ( );
			Emini1MinRealDataTest ( );

			Console.WriteLine ( "Press enter to exit..." );
			Console.ReadLine ( );
		}
		//-----------------------------------------------------------------------------------------------
		public static void EminiTest ( )
		{
			EMini1MinStaticAdapter ad = new EMini1MinStaticAdapter ( );
			ad.CacheData ( );
			ad.LoadSymbol ( "", "EMDZ7", null, DateTime.Now, DateTime.Now, 100 );
		}
		//-----------------------------------------------------------------------------------------------
		...
		//-----------------------------------------------------------------------------------------------
		static void Emini1MinRealDataTest ( )
		{
			Emini1MinRT.Emini1MinRealData rd = new Emini1MinRT.Emini1MinRealData ( );
			Application.Run ( new Form ( ) );

			//rd.OpenRequest ( "ESZ7", 50, BarIntervalEnum.biMinutes, 5, false,
